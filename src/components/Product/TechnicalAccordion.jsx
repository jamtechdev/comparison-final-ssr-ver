...
const TechnicalAccordion = React.memo(({ product, overallScoreColor }) => {
    console.log(product, overallScoreColor, "technical");
    ...
    return (
        <>
            <Accordion className="table-accordion w-50 p-0 left-accordion">
                ...
                {product && getAttributeHalf(product, "first") &&
            ...
            <Accordion className="table-accordion w-50 p-0 right-accordion">
                {product && getAttributeHalf(product, "second") &&
